...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3017732,3013650,3017501,37045722,4148615)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (3017732,3013650,3017501,37045722)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (320073,4119158,432881,440689)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (320073,4119158,432881,440689)
  and c.invalid_reason is null
...
WHERE (C.value_as_number >= 0.0100 and C.value_as_number <= 0.5000)
AND C.unit_concept_id in (44777588,9444,8848,8961)
...
WHERE (C.value_as_number >= 50.0000 and C.value_as_number <= 500.0000)
AND C.unit_concept_id in (8784)
-- End Measurement Criteria
