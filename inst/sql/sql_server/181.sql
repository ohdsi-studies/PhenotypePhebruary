...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4146536)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4146536)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4013964,37392176)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37392176)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37392926,37208831,37208830,37392198,37392176,37208596,37394438,37392200,4013964)

) I
) C UNION ALL 
SELECT 8 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45557228,1568306,1568304,4309257,1568300,374915,40483317,380378)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
WHERE (C.value_as_number >= 10.0000 and C.value_as_number <= 50.0000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 78.0000 and C.value_as_number <= 1000.0000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria

) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= DATEADD(day,7,P.START_DATE) ) cc 
...
WHERE (C.value_as_number >= 10.0000 and C.value_as_number <= 119.3000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 178.9500 and C.value_as_number <= 1000.0000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 10.0000 and C.value_as_number <= 160.0000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 192.0000 and C.value_as_number <= 1000.0000)
AND C.unit_concept_id in (8749,8753,9586,4124446,4121402,4120726,8750,8647,4117651,9015,9573)
-- End Measurement Criteria
...
select C.person_id, C.observation_period_id as event_id, DATEFROMPARTS(2011, 12, 31) as start_date, C.observation_period_end_date as end_date,
...
WHERE C.OBSERVATION_PERIOD_START_DATE <= DATEFROMPARTS(2011, 12, 31) and C.OBSERVATION_PERIOD_END_DATE >= DATEFROMPARTS(2011, 12, 31)
